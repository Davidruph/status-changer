<?php
    include('functions/add_usersController.php');
?>
...
<main>
    <div class="container-fluid">
     ...
     <div class="card-box">
        <div class="col-md-8">
        <form class="form-horizontal" method="post" autocomplete="off" action="add-users.php">
           ...
           <div class="row mb-3">
                <div class="col">
                  <label for="full_name">User Country</label>
                ...
                <div class="col">
                     <label for="Number">User mobile number</label>
